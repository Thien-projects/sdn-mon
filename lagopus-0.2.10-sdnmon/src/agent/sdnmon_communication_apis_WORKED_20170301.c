...
/*
 * @THIEN: 2016-05-09
 * Get m_entry_stats_list of all m_entry in monitoringdb.
...
lagopus_result_t sdnmon_insert_m_entry_from_controller(uint64_t dpid, struct m_key *m_key){
	...
	return insert_m_entry_from_controller(bridge->monitoringdb, m_key);
}
