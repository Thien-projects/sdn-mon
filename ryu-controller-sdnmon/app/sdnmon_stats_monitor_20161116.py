...
#THIEN: 2016-05-04
    ...
    def _experimenter_mp_handler(self, ev):
        ...
        M_ENTRY_BUCKET_COUNTER_PACK_STR = '!IIHHBQQ' #'!QQ' #'!HHQQ'  # '!HHBQQ' #'!QQ'
        M_ENTRY_BUCKET_COUNTER_SIZE = 29 #16 #32 # 16 bytes: packet_count+byte_count, 4 bytes: srcPort+dstPort, 1 byte: proto, 8bytes: srcIp+dstIp (uint32_t)
