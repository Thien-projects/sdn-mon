...
#THIEN: 2016-05-04
    ...
    def _experimenter_mp_handler(self, ev):
        ...
        for stat in sorted(body):
            number_m_entries += 1
#             self.logger.info('%02x %8x %8d %8d %8d %8d %16d %16d',
#                              ev.msg.datapath.id, (stat.packet_count - 9007199254740992),
#                              stat.byte_count, stat.proto, stat.src_port,
#                              stat.dst_port, stat.src_ip, stat.dst_ip)
        print('#m_entries received from switch: %d', number_m_entries)
#     @set_ev_cls(ofp_event.EventOFPExperimenterStatsReply, MAIN_DISPATCHER)
#     def _experimenter_mp_handler(self, ev):
#         body = ev.msg.body
#         
