...
#THIEN: 2016-05-04
    ...
    def _experimenter_mp_handler(self, ev):
        ...
        M_ENTRY_BUCKET_COUNTER_PACK_STR = '!QQ3xB' #'!Q' #'!IIHHB3xQQ' #'!IIHHBQQII' # #'!QQ' #'!HHQQ'  # '!HHBQQ' #'!QQ'
        M_ENTRY_BUCKET_COUNTER_SIZE = 20 #16  #8  #32 #29 #37 #29 #16 #32 # 16 bytes: packet_count+byte_count, 4 bytes: srcPort+dstPort, 1 byte: proto, 8bytes: srcIp+dstIp (uint32_t), 
        ...
        while(offset < data_len):
            ...
            print('m_entry: ', m_entry[0] - 4503599627370496, m_entry[1]) #& 0xFFF7FFFFFFFFFFFF)
