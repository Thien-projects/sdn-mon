...
class SimpleMonitor(simple_switch_13.SimpleSwitch13):
    ...
    def _request_stats(self, datapath):
        ...
        req = parser.OFPExperimenter(datapath, experimenter=0x01, exp_type=0x01, data='0111')
        datapath.send_msg(req)
        self.logger.info('--------------')
        ...
        #time(15, 8, 24, 78915)
        #req = parser.OFPExperimenterStatsRequest(datapath, flags ='0', experimenter=0x01, exp_type=0x01, data='0110', type_=None)
        #datapath.send_msg(req)
    ...
    def _port_stats_reply_handler(self, ev):
        ...
        self.logger.info('datap/ath         port     '
...
#THIEN: 2016-05-04
    ...
    def _experimenter_mp_handler(self, ev):
        ...
        #self.logger.info('datapath         ' 'packets  bytes')
        #for stat in sorted(body):
        #    self.logger.info('%016x %8d %8d', ev.msg.datapath.id, stat.packet_count, stat.byte_count)
